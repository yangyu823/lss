...
function bar() {
    if (pick !== 1) {
        ...
        if ((parseInt(d3.select("tr").style('width'))) * 4 / 5 <= 1140) {
            ...
            height = (parseInt(d3.select("tr").style('width')) * 2 / 5) - margin.top - margin.bottom
        } else {
        ...
        if ((parseInt(d3.select("tr").style('width'))) * 4 / 5 <= 1140) {
            width = ((parseInt(d3.select("tr").style('width')) * 4 / 5) - margin.left - margin.right)
            height = (parseInt(d3.select("tr").style('width')) * 1 / 3) - 2 * margin.bottom
        } else {
            width = 1140 - margin.left - margin.right
            height = 475 - 2 * margin.bottom
        }
