...
function bar() {
    if (pick !== 1) {
        ...
        svg.selectAll("bar")
            ...
            .append("text")
            .attr("x", function (d) {
                return x(d.label) + (x.bandwidth()) * 4 / 10;
            })
        ...
        if (!showtable) {
            ...
            sep_bar.append('text')
                .attr('id', "test001")
                .attr("x", function (d) {
                    return x(d.data.practiceTeam) + x.bandwidth() * 0.4;
                })
                .attr("y", function (d) {
                    return y(d[1]);
                })
...
//Switch Button Function - Yu
{
    ...
    function initial() {
        ...
        if (pick === 1) {
            data_lss = data_total;
            keys = key_peel;
            document.getElementById("title_three").style.display = "block";

        } else {
            document.getElementById("title_two").style.display = "block";
        }
        bar_chart();
    }
