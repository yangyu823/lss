...
<html lang="en-US">
	<head>
		...
		<style type="text/css">
			...
			.leftpanea:hover {
			 ...
			 .leftpanea:active,  .leftpanea:visited:active {font-size: 120%; }
			 .leftpanea.active {
				background: <?php echo $team_color; ?>; 
				font-size: 120%; 
				color: white;
	...
	<body class="home" >
		<header>
			<nav class="navbar navbar-expand-lg bgteam">
				<div class ="page-title" style="opacity: 1 !important; ">
					<a href="home.php" rel="home"><img src="img/logo.png" alt="Logo" style = " height: 40px;width: 35px; opacity: 1 !important; ">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent" style='margin-left:30%'>
					...
					<form class="form-inline my-2 my-lg-0" method="post">		
						<h6 style="margin:0;">Welcome <a href='resource.php' style='color:white; font-weight:bold; '><?php echo $_SESSION['fullname'];?></a></h6>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<button class="btn btn-primary" type="submit" name="logout" id="logout">Logout</button>
					</form>
				</div>
			</nav>
		</header>
		<table class="tncellspace" style = " width:100%; height:100%; background-color: transparent ; border: none !important; border-radius:10px; border-spacing: 0px; table-layout:fixed">
			<tbody>
				<tr style = " border: none !important; margin : 0px">
					<td style="text-align:center; color: white; padding:0; border: none ;  width:20% ;background: #f0f0f5; overflow:hidden ">
						<table  class="tncellspace" style = "background-color: transparent; border-spacing: 0px; border: none !important; border-radius:10px; width:100%; height:100%; ">
							<tbody>								
								...
								<tr style="  border: none; height:70%;">
									<td  style="border: none ;padding:0; opacity: 0.7; text-align:top" valign="top">
										...
										&nbsp;<span style = 'font-size: 1rem; padding-bottom:8px;'><a class='leftpanea active' href="#" id="livestatlink"> &nbsp;&nbsp;Live Status &nbsp;  </a></span></br>
										&nbsp;<span style = 'font-size: 1rem; padding-bottom:8px;'><a class='leftpanea' href="#" id="addresourlink"> &nbsp;&nbsp;Add New Resource &nbsp; </a></span></br>
										&nbsp;<span style = 'font-size: 1rem; padding-bottom:8px;'><a class='leftpanea' href="#" id="searchrlink"> &nbsp;&nbsp;Search Resource &nbsp; </a></span></br>
										&nbsp;<span style = 'font-size: 1rem; padding-bottom:8px;'><a class='leftpanea' href="#" id="Requestreslink"> &nbsp;&nbsp;Request Management &nbsp;  </a></span></br>
										&nbsp;<span style = 'font-size: 1rem; padding-bottom:8px;'><a class='leftpanea' href="#" id="Managealloclink"> &nbsp;&nbsp;Manage Allocations &nbsp;  </a></span></br>
					...
					<td  style="text-align:center;  padding:0px ; border: none ;border-radius:40px !important ; width:80% ; overflow:hidden  " valign="top">
							...
							<table style="text-align:center;width:100%">
								<tbody>
									...
									<tr style="text-align:center; height:20%" align="center">
										...
										<td style='width:60%'>
											<div class="input-group" style='width:100%;'>
											  <input class="form-control my-0 py-1 red-border" type="text" placeholder="Search by Name, UserId, Skills" aria-label="Search" style='float:center' id='searchval' name='searchval'>
											  <div class="input-group-append">
												<span class="input-group-text red lighten-3" id="basic-text1"><a href="#" id="searchlnki" name="searchlnki" class="fa fa-search text-grey" aria-hidden="true"></a></span>
											  </div>
											</div>
										</td>
										<td style='width:20%'></td>
									...
									<tr style="text-align:center; height:60%">
										<td style='width:20%'></td>
										<td style='width:60%'><div id='appneddata' style='height:400px;overflow-y:auto'></div></td>
										<td style='width:20%'></td>
									</tr>									
								</tbody>
							</table>
						...
						<div id="addresour" name="addresour" style="display:none; padding-top:60px">
							...
							<form id="regFormaddresou" class="regForm">
									<h4 style=" font-family: Akkurat;  
											...
											line-height: normal;  
											letter-spacing: normal;  
											color: white; background : <?php echo $team_color; ?>; opacity:.5 ;border-radius: 2px;"> Add new resource </h4>
								  ...
								  <!-- One "tab" for each step in the form: -->
									...
									<div class="tab" name="basinfo" id="basinfo" align="center" style="display:block">
										...
										<table style= "table-layout:auto;width:75%;">
											<tr>
												...
												<td>
													<div class="field">
														<input type="email" name="email" id="email" placeholder="Fname.Lname@team.telstra.com">
										...
										<table align = "center" style= "table-layout:auto;width:25%;">
											...
											<div class='field'>
											<select name="specialization" id="specialization"  style= "width: 100%;border:0px;outline:0px;" >
									...
									<div class="tab" name="tminfo" id="tminfo" align="center" style="display:none">			
										...
										<table style= "table-layout:auto;width:75%;">
											<tr>
												<td style= "padding: 15px;" width="50%">
													<select name="dirreport" id="dirreport"  style= "width: 100%;border:0px;outline:0px;">
												...
												<td style= "padding: 15px;" width="50%">
													<select name="pexmanager" id="pexmanager"  style= "width: 100%;border:0px;outline:0px;">
										...
										<table align = "center" style= "table-layout:auto;width:25%;">
											<tr>
											<td style="padding:0 !important;"><input id='reldate' name='reldate' class = 'datepicker' type='text' placeholder='Release Date'></input></td>
											</tr>
										</table>					
									</div>
									</br>
									...
									<div style="float:right;">
										  <button type="button" id="prevBtn" style = "background-color:green;color:white;display:none">Previous</button>
										  <button type="button" id="nextBtn" style = "background-color:green;color:white">Next</button>
										  <button type="button" id="subBtn" style = "background-color:green;color:white;display:none">Submit</button>
										</div>
									</div>
								...
								<form id="infodiv" class="regform" style="box-shadow: 0 15px 20px rgba(0, 0, 0, 0.5); border-radius:6px;display:none">
									<div class="row">
										<div class="col"></div>
										<div class="col-8" align="center">
											<a><i class="fa fa-check-circle" style='color:green;font-size:25px'></i> User has been added successfully in L&SS Portal and mail has been sent to user with credentials</a><br>
										</div>
										<div class="col"></div>
									</div>
									<br>
						...
						<div id="Requestres" name="Requestres" style="display:none; padding-left:20px; padding-right:20px;padding-top:60px ">
								...
								<table class='table' style="text-align:center; width:100% ; " id='reqtable'>
									<thead style="overflow: auto; ">
										<tr style="text-align:center; height:45px ; position: relative; ">
											...
											<td>	
												<a href = '#' id='sfilter' name='sfilter'><i class='fa fa-eye fa-fw'></i>Filters</a>
											</td>	
										</tr>
									</thead>
									<thead  style="overflow: auto; ">
										<tr style="position: relative; ">
											...
											<th style='width:10%'><a href = '#' id='regFormaddresqlink' name='regFormaddresqlink' style='color:green'><i class='fa fa-plus fa-fw'></i>Request</a></th>
										</tr>
									</thead>
									<tbody  style="overflow: auto; ">
										<tr id='reqfilter' style='display:none'>
											...
											<td><input style='text-align: center !important; width:100%'/></td>
											<td><input style='text-align: center !important; width:100%'/></td>
											<td><a href = '#' id='clrfilter' name='clrfilter'><i class='fa fa-eye-slash fa-fw'></i>Filters</a></td>
										</tr>
										<?php											  
											$connect= mysqli_connect($hostname,$uname,$pwd,$dbname);
											if ($connect->connect_error) 
							...
							<div id="regFormaddresq" style="display:none">
								...
								<form class="regForm" >
									<h4 style=" font-family: Akkurat;  
											...
											line-height: normal;  
											letter-spacing: normal;  
											color: white; background : <?php echo $team_color; ?>; opacity:.5 ;border-radius: 2px; "> Create  request </h4>
										<hr style ="margin:0"></hr>
									<div class="tab" name="basinfo" id="basinfo" align="center" style="display:block">
										<table  style= "table-layout:auto;width:75%;">
											...
											<tr style="padding: 15px !important;">
												<td>
													<div class="field">
														<input type="text" name="fteamin" id="fteamin" placeholder="Feature Team...">
														<label for="fteamin">Feature Team...</label>
													</div>
												</td>
												<td>
													<div class="field">
														<input type="text" name="pnamein" id="pnamein" placeholder="Project name...">
											...
											<tr style="padding: 15px !important;">
												...
												<td>
													<div class="field">
														<input type="text" name="ppocin" id="ppocin" placeholder="Project POC...">
											...
											<tr style="padding: 15px !important;">
												<td>
													<div class="field">
														<input class = 'datepicker' type="text" name="sdatein" id="sdatein" placeholder='Start Date...'>
														<label for="sdatein">Start Date...</label>
													</div>
												</td>
												<td>
													<div class="field">
														<input class = 'datepicker' type="text" name="edatein" id="edatein" placeholder='End Date...'>
									...
									<div style="overflow:auto;">
										<div style="float:right;">
											<a href='#' id ="Requestreqsdetailslinkcancel"><button type="button" style = "background-color:#f7a438 !important; color:white;"> Cancel </button></a>&nbsp; &nbsp; 
											<a href='#' id ="Requestreqsdetailslink"><button type="button" style = "background-color:green;color:white;"> Save </button>&nbsp; &nbsp; </a>
											<a href='#' id ="regFormaddresqallocreslink"><button type="button" style = "background-color:green;color:white"> Save & Allocate </button></a>
											<button type="button" style = "background-color:green;color:white;display:none"> Allocate </button>
										</div>
									</div>
									<br>
								</form>
							...
							<div id="regFormaddresqallocres" style=" display:none" >
								...
								<form class="regForm" style=" width: 100% !important;">
									<h4 style=" font-family: Akkurat;  
											...
											line-height: normal;  
											letter-spacing: normal;  
											color: white; background : <?php echo $team_color; ?>; opacity:.5 ;border-radius: 2px; "> Resource Allocation </h4>
									<hr style ="margin:0"></hr>
									...
									<div class="tab" name="basinfo" id="basinfo" align="center" style="display:block">
										<table  style= "width:80%;" id='resallocatetable'>
											...
											<tr style ="border-bottom: 1px solid #eaeef0;"> 
												...
												<th colspan='6'>
												<br>
													<h5 class='w3-text-grey' style="color:grey;"><i class='fa fa-info fa-fw w3-margin-right w3-text-teal'></i><b>Request Details  </b> &nbsp;&nbsp;Project Name&nbsp;:&nbsp;<span id='pnamespan'></span> &nbsp;&nbsp;<i class='fa fa-calendar fa-fw w3-margin-right'></i>Duration&nbsp;:&nbsp;<span id='startdatespan'></span></h5>
											...
											<tr style="padding: 10px !important;">
												<td style= "padding: 5px; width: 20% !important;">
													<div class="field">
														<input type="text" id ='resallocateresnamein' name='resallocateresnamein[]' size="30"  placeholder="Resource Name..." >
														<label for="resallocateresnamein">Resource Name...</label>
													</div>
												</td>
												<td style= "padding: 5px; width: 15% !important;">
													<div class="field">
														<input class = 'datepicker' type='text' id='resallocatesdin' name='resallocatesdin[]' size="15" placeholder='Start Date...'>
												...
												<td style= "padding: 5px; width: 15% !important;">
													...
													<div class="field">
														<input class = 'datepicker' type='text'  size="15" placeholder='End Date...'  id='resallocateedin' name='resallocateedin[]' >
														<label for="resallocateedin">End Date...</label>
													</div>
												</td>
												<td style= "padding: 5px; width: 10% !important;">
													<div class="field">
														<input type='number'  size="8" placeholder="Percentage..."   id='resallocperin' name='resallocperin[]' >
														<label for="resallocperin">Percentage...</label>
													</div>
												</td>
												<td style= "padding: 5px; width: 30% !important;">
													<div class="field">
														<input type='text'  size="5"  placeholder="Message..."  id='resalloccomin' name='resalloccomin[]' >
														<label for="resalloccomin">Message...</label>
													</div>
												</td>		
												<td style= "width: 10% !important;" id='addresourceplustd'> <a href="#" style='color:green' id='resallocate'><i class='fa fa-plus fa-fw'></i></a></td>
											</tr>
											<tbody>
										</table>				
										<br><br>												
									...
									<div style="overflow:auto;">
										<div style="float:right;">
											<a href='#' id ="reqallocresourcecancel"><button type="button" style = "background-color:#f7a438 !important; color:white;"> Cancel </button></a>&nbsp; &nbsp; 
											<a href='#' id='Requestreqsdetailslinks'> <button type="button" style = "background-color:green;color:white">Allocate and Submit</button></a>
										</div>
									</div>
									<br>								
								</form>
						...
						<div id="Managealloc" name="Managealloc" class ="row" style="display:none; padding-left:20px; padding-right:20px;padding-top:60px;  ">
							<h4 style=" font-family: Akkurat;  
											font-size: 36px;  
											font-weight: bold;  
											font-style: normal;  
								...
								<table id='legend' style=' width:70%;  margin-left: 230px !important'>
									<tbody>
										<tr>
											...
											<td style='background-color:grey;border-top-left-radius:10px !important;border-bottom-left-radius:10px !important;' align='center'><a style='color:black;width:0%'>0% Available</a></td>
											<td style='background-color:red' align='center'><a style='color:black;width:100%'>Allocated less than 50%</a></td>
											<td style='background-color:#da9645' align='center'><a style='color:black;width:100%'>Allocated between 50% to 99%</a></td>
											<td style='background-color:Green;border-top-right-radius:10px !important;border-bottom-right-radius:10px !important' align='center'><a style='color:black;width:100%'>100% Allocated</a></td>
										</tr>
									</tbody>
								</table>
							</div>
		...
		<a href='#' data-target='#addresourcemod' data-toggle='modal' id='dummylnk' name='dummylnk' style='display:none'></a>
	</body>
</html>
